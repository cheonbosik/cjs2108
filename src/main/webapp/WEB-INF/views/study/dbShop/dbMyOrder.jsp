...
<head>
  ...
  <script>
    ...
    function myOrderStatus() {
    	...
    	location.href="${ctp}/dbShop/myOrderStatus?startJumun="+startJumun+"&endJumun="+endJumun+"&conditionOrderStatus="+conditionOrderStatus+"&pag=${pag}";
    }
  </script>
</head>
<body>
...
<div class="container">
  ...
  <!-- 블록 페이징처리 시작(BS4 스타일적용) -->
	...
	<!-- 블록 페이징처리 끝 -->
  <hr/>
  <p class="text-center"><a href="${ctp}/dbShop/dbShopList" class="btn btn-secondary">계속쇼핑하기</a></p>
  <hr/>
<p><br/></p>
</div>
